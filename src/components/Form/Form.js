...
import Radio from '../Form/RadioForm';
      ...
      <AppContext.Consumer>
        {(context) =>(
          <div className={styles.wrapper}>
            ...
            <form autoComplete="off" className={styles.form} onSubmit={(event) => context.addItem(event, this.state)}>
              ...
              <Input onChange={this.handleInputChange} value={this.state.title} name="title" label={type === types.twitter ? 'Twitter Name' : 'Title'}  />
              ...
              {type === types.twitter ? <Input onChange={this.handleInputChange} value={this.state.image} name="image" label="image" /> : null}
